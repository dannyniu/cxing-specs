...
// Versioning follow semantic versioning; revisions are added one after another
// in form of variable redefinitions; each change of minor version follow the
// last redefinition of their respective revision redefinition; each change of
// major version follow the last redefinition of the minor version
// redefinition. the assignment to `$spec_semver` comes last to receive the
// latest defined value.
$spec_majver = "0"; # 2025- still drafting.
$spec_minver = "1"; # 2025- still drafting.
$spec_revver = ""; # 2025- still drafting.
