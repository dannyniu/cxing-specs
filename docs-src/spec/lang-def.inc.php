<?php
  if( !($GLOBALS['langdefs'] ?? false) )
  {
    ...
    $spec_revver = "2"; # 2026-01-25.
    $spec_revver = "3"; # 2026-02-24.
    $spec_revver = "4"; # 2026-04-09.
    $spec_revver = "5"; # 2026-05-04.
    $spec_revver = "6"; # 2026-05-11.
    $spec_revver = "7"; # 2026-05-26.
    $spec_revver = "8"; # 2026-06-17.
    $spec_majver = "1"; # 2026-06-21.
    $spec_minver = "0"; # 2026-06-21.
    $spec_revver = "0-alpha.1"; # 2026-06-21.
    $spec_revver = "0-alpha.2"; # 2026-06-29.
    $spec_revver = "0-beta.1"; # 2026-06-30.
